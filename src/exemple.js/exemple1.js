...
// переменной value.Используй методы Math.floor(), Math.ceil() и Math.round().
...
// Составь фразу с помощью шаблонных строк A has B bots in stock, где A, B - переменные
//вставленные в строку.
...
// Вес и высота хранятся в переменных weight и height, но не как числа, а в виде
// строк(специально для задачи).Нецелые числа могут быть заданы в виде 24.7 или 24, 7,
...
// присваиваться значение defaultValue.Проверь работу скрипта для слепдующих значений
// переменной incomingValue: null, undefined, 0, false.Используй оператор ??
